<section class="relative h-72 bg-yellow-800  flex flex-col justify-center align-center text-center space-y-4 mb-4">
  ...
  <div class="z-10">
    ...
    <div>
      ...
      @endauth --}}
      <a class="inline-block border-2 border-white text-white py-2 px-4 rounded-xl uppercase mt-2 mx-4 hover:text-black hover:border-black"
        href="/allpost">All POST</a>
      ...
      <a class="inline-block border-2 border-white text-white py-2 px-4 rounded-xl uppercase mt-2 mx-4 hover:text-black hover:border-black"
        href="/bookChapter">Book Chapter</a>
